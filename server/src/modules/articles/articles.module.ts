...
import { Article, ArticleLike, ArticleTag, ArticleVersion, Category, Tag, User } from '@database/entities';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([Article, Category, Tag, ArticleTag, ArticleVersion, User, ArticleLike]),
  ],
